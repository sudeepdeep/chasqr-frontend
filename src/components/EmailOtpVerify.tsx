...
export default function EmailOtpVerify({ email, onVerified, onBack }: EmailOtpVerifyProps) {
  ...
  return (
    <div className="text-center">
      ...
      <h2 className="font-bebas text-3xl text-slate-900 mb-1">Check your email</h2>
