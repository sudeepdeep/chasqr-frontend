...
const CHAPTERS = [
  {
    ...
    url: "app.chasqr.io/deploys",
    slot: "chapter-01-ship",
    label: "01 Ship",
    points: [
  ...
  },
  {
    ...
    url: "app.chasqr.io/builder",
    slot: "chapter-02-build",
    label: "02 Build",
    points: [
  ...
  },
  {
    ...
    url: "app.chasqr.io/domains",
    slot: "chapter-03-secure",
    label: "03 Secure",
    points: [
  ...
  },
  {
    ...
    url: "app.chasqr.io/seo",
    slot: "chapter-04-grow",
    label: "04 Grow",
    points: [
  ...
  },
  {
    ...
    url: "app.chasqr.io/analytics",
    slot: "chapter-05-measure",
    label: "05 Measure",
    points: [
...
const STEPS = [
  {
    num: "01",
    title: "Upload",
    body: "Drag a folder in or connect a repository.",
  },
  {
    num: "02",
    title: "Share",
    body: "Your site is live on a URL you can send straight away.",
  },
  {
    num: "03",
    title: "Iterate",
    body: "Edit, redeploy, and watch the change go out in seconds.",
  },
];
...
const FEATURES = [
  ...
  [
    ...
    "One A record; certificates issued and renewed for you.",
  ],
...
const COMPARE_ROWS = [
  ...
  [
    ...
    "One A record, cert included",
    "Included",
    "You issue and renew it",
  ],
    ...
    loadThree()
      .then(({ THREE, GLTFLoader, RoomEnvironment }) => {
        ...
        new GLTFLoader().load(modelUrl, (gltf) => {
          ...
          model.position.sub(
            box.getCenter(new THREE.Vector3()).multiplyScalar(s),
          );
          group.add(model);
          ground.position.y =
            new THREE.Box3().setFromObject(group).min.y - 0.06;
          dirty = true;
        });
        ...
        const tick = () => {
          ...
          const nextLift =
            group.position.y + (targetLift - group.position.y) * 0.12;
          if (
            Math.abs(nextY - group.rotation.y) > 1e-5 ||
  ...
  const skin =
    variant === "primary"
      ...
      : {
          ...
          color: C.ink,
          border: `1px solid ${hover ? C.brand : C.line}`,
          padding: "0 20px",
        };
  return (
    <a
      ...
      >
        <div>
          ...
          <Reveal
            as="p"
            delay={120}
            style={{ ...LEAD, margin: "28px 0 0", maxWidth: "68ch" }}
          >
            Push to GitHub, upload a folder, or build it visually. Your site
            goes live on a URL straight away - no servers, no pipelines, no
            monthly bill.
          </Reveal>
          <Reveal
            delay={180}
          ...
          <Reveal
            as="p"
            delay={240}
            style={{ margin: "16px 0 0", fontSize: 14, color: C.body }}
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ ...LEAD, margin: "18px 0 0", maxWidth: "52ch" }}>
          {c.lead}
        </p>
...
function CtaBand() {
  return (
    <section
      id="cta"
      style={{ background: C.brand, padding: "112px 24px", marginTop: 128 }}
    >
      <Reveal
        style={{
          ...SHELL,
...
function Steps() {
  ...
  return (
    <section id="steps" style={{ padding: "128px 24px" }}>
      <div style={SHELL}>
        <Reveal as="h2" style={{ ...H2, marginBottom: 64 }}>
          Live in three steps
        </Reveal>
...
function Compare() {
  ...
  return (
    <section
      id="compare"
      aria-label="How Chasqr compares"
      style={{ padding: "0 24px 128px" }}
    >
      <div style={SHELL}>
        <Reveal as="h2" style={{ ...H2, marginBottom: 16 }}>
          How this compares
        </Reveal>
        <Reveal
          as="p"
          delay={60}
          style={{ ...LEAD, margin: "0 0 48px", maxWidth: "62ch" }}
        >
        ...
        >
          <div style={{ minWidth: 720 }}>
            <div style={{ ...grid, borderBottom: `1px solid ${C.line}` }}>
              <div style={{ ...EYEBROW, color: C.muted, padding: "18px 24px" }}>
                Capability
              </div>
            ...
            {COMPARE_ROWS.map((row, r) => (
              ...
              >
                <div
                  style={{ padding: "16px 24px", fontSize: 16, color: C.ink }}
                >
                  {row[0]}
                </div>
    ...
    >
      <div
        style={{
          ...SHELL,
          display: "grid",
          gridTemplateColumns: desktop ? "0.42fr 1fr" : "1fr",
          gap: 64,
        }}
      >
        <div>
          <Reveal as="h2" style={H2}>
            Questions
          </Reveal>
          <Reveal
            as="p"
    ...
    >
      <div
        style={{
          ...
          display: "grid",
          gridTemplateColumns: desktop ? "0.9fr 1fr" : "1fr",
          gap: 64,
          alignItems: "start",
        }}
      >
        <Reveal>
          ...
          <p style={{ ...LEAD, margin: "16px 0 0", maxWidth: "46ch" }}>
            Questions about migrating a site, a domain that will not resolve, or
            whether Chasqr fits what you are building. We answer.
          </p>
        ...
        {sent ? (
          ...
          >
            ...
            >
              Thanks — we have it. Expect a reply at the address you gave,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav
          aria-label="Footer"
          style={{ display: "flex", gap: 24, fontSize: 14, fontWeight: 500 }}
        >
          {links.map(([label, href]) => (
            <a
              key={label}
              href={href}
              style={{ color: C.body, textDecoration: "none" }}
            >
              {label}
            </a>
          ))}
  ...
  useScrollTick(() => {
    ...
    if (desktop) {
      ...
      const p = Math.min(
        ...
        Math.max(
          0,
          (PIN - wrap.getBoundingClientRect().top) / Math.max(1, total),
        ),
      );
      setActive(
        Math.min(CHAPTERS.length - 1, Math.floor(p * CHAPTERS.length + 0.001)),
      );
      return;
    }
  ...
  const jump = useCallback(
    (i) => {
      ...
      if (desktop) {
        ...
        window.scrollTo({
          top: top + total * ((i + 0.45) / CHAPTERS.length),
          behavior,
        });
        return;
      }
      ...
      if (!art) return;
      window.scrollTo({
        top: art.getBoundingClientRect().top + window.scrollY - PIN - 24,
        behavior,
      });
    },
    [desktop, reduced],
